...
.proc update_player_1
  ...
  BCC no_ball_collision               ; If carry clear, no collision
    ...
    STA ball_dx
    ; Play sound effect for paddle hit
    lda #%00000001  ;enable Sq1
    sta $4015

    ;Square 1
    lda #%10111000 ;Duty 10, Volume F
    sta $4000
    ...
    STA $4004 ; SQUARE 2 ENVIRONMENT

    LDA #$A9
    STA $4006 ; LOW 8-BITS OF PERIOD

    LDA #$00
    STA $4007 ; HIGH 3-BITS OF PERIOD
    ;TRIANGLE
    LDA #%10000001
    STA $4008 ; TRIANGLE ENVIRONMENT

    LDA #$42 ; A PERIOD OF $042 PLAYS A g# IN NTSC MODE
    STA $400a ; LOW 8-BITS OF PERIOD

    LDA #$00
    STA $400b ; HIGH 3-BITS OF PERIOD
